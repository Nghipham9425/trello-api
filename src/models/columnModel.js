...
const createNew = async (data) => {
  try {
    ...
    //Bien doi cac du lieu string thanh object Id
  ...
  try {
    const result = await GET_DB()
      ...
      .findOneAndUpdate(
        ...
        { $push: { cardOrderIds: new ObjectId(card.id) } },
...
const update = async (columnId, updateData) => {
  try {
    ...
    if (updateData.columnId) {
      updateData.columnId = ObjectId(updateData.columnId)
    }
  ...
  try {
    const result = await GET_DB()
      ...
      .findOneAndUpdate(
        ...
        { $pull: { cardOrderIds: new ObjectId(column.id) } },
        { returnDocument: 'after' }
      )
